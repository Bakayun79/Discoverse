...
if(empty($_SESSION['signed_in'])){
	if($_SERVER['REQUEST_METHOD'] != 'POST'){
        ...
        <div class="hb-contents-wrapper"><div class="hb-container hb-l-inside">
            <h2>Sign Up</h2>
            <p>Create a User ID for Discosuck.</p>
        </div>
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="hb-container hb-l-inside-half hb-mg-top-none">              
                ...
                <div class="auth-input-double">               
                    <label>
                        <input type="text" name="username" maxlength="16" title="Discosuck ID" placeholder="User ID" value="">
                    </label>
                    <label>
...
$forbidden = array("faggot", "nigga", "whore", "nigger", "fucker", "fuck", "fucking", "fucka", "zipperhead", "sex", "cunt", "anal", "dick", "cock", "bitch", "kike", "towelhead", "gook", "spic", "kill yourself", "penis", "vagina", "pussy", "kys", "suicide", "sexy", "niggas");
	function match($wrongwords, $string) {
		...
		$errors[] = 'Your User ID contains a word that is not allowed on Discosuck.';
	}
		...
		$errors[] = 'Your name contains a word that is not allowed on Discosuck.';
	}
    		...
    		if (!empty($errors)){
    			...
    			$new_user->bind_param('sssss', $username, $password_gen, $name, $face, "0.0.0.0");
    			$new_user->execute();
